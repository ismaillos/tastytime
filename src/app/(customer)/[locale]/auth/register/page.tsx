...
import { signUpSchema, type SignUpInput } from '@tastytime/validators'
    ...
    <div className="min-h-screen bg-neutral-950 flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl bg-neutral-900 border border-neutral-800 p-6">
          <h1 className="text-xl font-bold text-white mb-6">{t('signUp')}</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              <label className="mb-1 block text-sm font-medium text-neutral-300">{t('phone')} <span className="text-neutral-600">(optionnel)</span></label>
              <div className="relative">
          ...
          <p className="mt-6 text-center text-sm text-neutral-500">
            ...
            <Link href={`/${locale}/auth/login`} className="text-yellow-400 hover:text-yellow-300 font-medium">
              {t('signIn')}
            </Link>
          </p>
        </div>
